...
// Repere fichier YumariaJobs: evenement public expose aux autres plugins (YumariaActionRejectedEvent).
...
public final class YumariaActionRejectedEvent extends Event {
    ...
    public YumariaActionRejectedEvent(YumariaActionReport report, YumariaActionResult result) {
        this.report = report;
        this.result = result;
    }
